...
import { createApiForServer, createNextApiForServer, createSdkForServer, type ServerApi } from "@/utils/server"
...
type ServerSDKBase = {
  ...
  nextApi: ReturnType<typeof createNextApiForServer>
  event: {
...
function createServerSdkContextBase(server: ServerConnection.Any, scope: ServerScope): ServerSDKBase {
  ...
  const nextApi = createNextApiForServer({ server: server.http, fetch: platform.fetch })
